...
public class MainActivity extends AppCompatActivity {
    ...
    private void calculate(){
        if(firstCard==secondCard){
            ...
            iv_14.setImageResource(R.drawable.kotak);
            iv_21.setImageResource(R.drawable.kotak);
            iv_22.setImageResource(R.drawable.kotak);
            iv_23.setImageResource(R.drawable.kotak);
            iv_24.setImageResource(R.drawable.kotak);
            iv_31.setImageResource(R.drawable.kotak);
            iv_32.setImageResource(R.drawable.kotak);
            iv_33.setImageResource(R.drawable.kotak);
            iv_34.setImageResource(R.drawable.kotak);
    ...
    private void frontOfCardResources(){
        image101=R.drawable.falls1;
        image102=R.drawable.falls2;
        image103=R.drawable.falls3;
        image104=R.drawable.falls4;
        image105=R.drawable.falls5;
        image106=R.drawable.falls6;
        image201=R.drawable.falls1b;
        image202=R.drawable.falls2b;
        image203=R.drawable.falls3b;
        image204=R.drawable.falls4b;
        image205=R.drawable.falls5b;
        image206=R.drawable.falls6b;
    }
}